...
{
    [Fact]
    public void ProjectAndWindowsManifest_AreAlignedOnVersion170Build17()
    {
        ...
        Assert.Equal("17.0", GetProjectProperty(csproj, "AppDisplayVersion"));
        ...
        Assert.Equal("17.0.17.0", (string?)identity!.Attribute("Version"));
    }
